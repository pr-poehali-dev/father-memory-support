...
export default function Index() {
  ...
  const stories = [
    {
      name: 'Александр, 16 лет',
      text: 'Память об отце стала моей силой. Теперь я занимаюсь программированием — папа мечтал, чтобы я стал инженером.',
      achievement: 'Победитель хакатона'
    },
    {
      name: 'Мария, 15 лет',
      text: 'Когда мне тяжело, я вспоминаю его улыбку. Он верил в меня, и теперь я верю в себя. Занимаюсь танцами и помогаю другим.',
      achievement: 'Основала танцевальную студию'
    },
    {
      name: 'Дмитрий, 17 лет',
      text: 'Отец учил меня быть сильным. Сейчас я помогаю ребятам из нашего сообщества находить свой путь.',
      achievement: 'Волонтёр года'
    }
  ];
